...
public class DZ3 {
    ...
    private static String[][] jsnparsetoarray(String jsnstr){
        String line = jsnstr.substring(1, jsnstr.length() - 1); //"{"фамилия":"Иванов","оценка":"5","предмет":"Математика"}, {"фамилия":"Петрова","оценка":"4","предмет":"Информатика"}, {"фамилия":"Краснов","оценка":"5","предмет":"Физика"}" String
        String[] jsnarray = line.split(", "); //[{"фамилия":"Иванов","оценка":"5","предмет":"Математика"},{"фамилия":"Петрова","оценка":"4","предмет":"Информатика"},{"фамилия":"Краснов","оценка":"5","предмет":"Физика"}] String[3]
        String[][] jsnarrayofBase = new String[jsnarray.length][3];
        for(int i = 0; i < jsnarray.length; i++){
            line = jsnarray[i].substring(1, jsnarray[i].length() - 1);       //"фамилия":"Иванов","оценка":"5","предмет":"Математика"
            for(int j = 0; j < 3; j++){
                String[] minJsnarray = line.split(",");   //{"фамилия":"Иванов"},{"оценка":"5"},{"предмет":"Математика"}
                String[] microJsnarray = minJsnarray[j].split(":");     //{"фамилия"},{"Иванов"}
    ...
    private static String[] gluing_strings(String[][] arraystr){
        ...
        for(int i = 0; i < arraystr.length; i++){               //Студент Иванов получил 5 по предмету Математика.
